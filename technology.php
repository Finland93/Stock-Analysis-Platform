...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="real-estate.php" title="Real Estate Stocks">Previous</a></span> 
	<h1 class="PageHeading">Technology</h1>
	<span class="Next"><a href="services.php" title="Services Stocks">Next</a></span> 
	</div>
	<div class="clearfix"></div>
		...
		<?php
			...
			echo displaySectorAverages('TECHNOLOGY');
		?>
