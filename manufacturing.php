...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="energy.php" title="Energy Stocks">Previous</a></span> 
	<h1 class="PageHeading">Manufacturing</h1>
	<span class="Next"><a href="health-care.php" title="Health Care Stocks">Next</a></span> 
	</div>
	...
	<?php
		...
		echo displaySectorAverages('MANUFACTURING');
		?>  
