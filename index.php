...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
		<div class="col-md-12">
			<h1 class="centerText">Stock Analysis</h1>
			<p class="centerText">EXPLAIN THIS PRODUCT HERE</p>
		...
		<div class="share-buttons">
			...
			<!-- FAQ Section -->
			<section id="faq" class="container" itemscope itemtype="https://schema.org/FAQPage">
			<h2>FAQ for our platform</h2>
			<div class="faq-container">
				<div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="question">
						<h3 class="question-title" itemprop="name" id="question1">QUESTION 1</h3>
				...
				<div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="question">
						<h3 class="question-title" itemprop="name" id="question2">QUESTION 2</h3>
						<i class="fas fa-plus"></i>
					</div>
					<div class="answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
						<p itemprop="text">ANSWER</p>
				...
				<div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="question">
						<h3 class="question-title" itemprop="name" id="question3">QUESTION 3</h3>
						<i class="fas fa-plus"></i>
					</div>
					<div class="answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
						<p itemprop="text">ANSWER</p>
				...
				<div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="question">
						<h3 class="question-title" itemprop="name" id="question4">QUESTION 4 </h3>
						<i class="fas fa-plus"></i>
					</div>
					<div class="answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
						<p itemprop="text">ANSWER</p>
				...
				<div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="question">
						<h3 class="question-title" itemprop="name" id="question5">QUESTION 5</h3>
						<i class="fas fa-plus"></i>
					</div>
					<div class="answer" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
						<p itemprop="text">ANSWER</p>
