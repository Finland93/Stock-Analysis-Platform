...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="manufacturing.php" title="Manufacturing Stocks">Previous</a></span> 
	<h1 class="PageHeading">Health Care</h1>
	<span class="Next"><a href="real-estate.php" title="Real Estate & Construction Stocks">Next</a></span> 
	</div>
	...
	<?php
		...
		echo displaySectorAverages('LIFE SCIENCES');
	?>
