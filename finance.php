...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="services.php" title="Services Stocks">Previous</a></span> 
	<h1 class="PageHeading">Finance</h1>
	<span class="Next"><a href="energy.php" title="Energy Stocks">Next</a></span> 
	</div>
	<div class="clearfix"></div>
		...
		<?php
			...
			echo displaySectorAverages('FINANCE');
		?>   
