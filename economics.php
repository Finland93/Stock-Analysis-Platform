...
<div class="container">
	<div class="row">
		...
		<div class="col-md-12">
		<h1 class="PageHeading">Economics of USA</h1>
		<h2>Real Gross Domestic Product (GDP) </h2>
		<p>YOUR TEXT HERE TO EXPLAIN WHAT YOU DISPLAY HERE</p>	

		<div class="clearfix"></div>
		<?php
		require_once 'app/gdp-chart.php'; 
		echo generateGdpChartHtml();
		?>
	...
	<div class="row">
		...
		<div class="clearfix"></div>
		<?php
			require_once 'app/inflation-chart.php'; 
			echo generateInflationChartHtml();
		?>
		<!-- END OF PAGE -->
		</div>
	</div>
