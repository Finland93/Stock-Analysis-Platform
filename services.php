...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="technology.php" title="Technology Stocks">Previous</a></span> 
	<h1 class="PageHeading">Trade & Services</h1>
	<span class="Next"><a href="finance.php" title="Finance Stocks">Next</a></span> 
	</div>
	<div class="clearfix"></div>
		...
		<?php
			...
			echo displaySectorAverages('TRADE & SERVICES');
		?>
		<!-- Build Data table -->
