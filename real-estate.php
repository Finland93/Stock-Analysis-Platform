...
<div class="container">
  ...
  <!-- Use col-md-8 + col-md-4 for sidebar, use col-md-12 without sidebar -->
	...
	<span class="Previous"><a href="health-care.php" title="Health Care Stocks">Previous</a></span> 
	<h1 class="PageHeading">Real Estate & Construction</h1>
	<span class="Next"><a href="technology.php" title="Technology Stocks">Next</a></span> 
	</div>
	<div class="clearfix"></div>
	<!-- Display Averages -->
	<?php
		require_once 'app/sector-averages.php';
		echo displaySectorAverages('REAL ESTATE & CONSTRUCTION');
	?>   
